<?php
/**
 * Скопируйте в config.php и вставьте URL и токены агентов Timeweb.
 * config.php не коммитится.
 *
 * URL: карточка агента → Интеграции → «Скопировать OpenAI URL»
 * Токен: карточка агента → Управление → Доступ по API
 *    (не токен из раздела «API и Terraform»)
 */
return [
