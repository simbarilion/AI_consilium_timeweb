...
ROUND_TOPICS = [
    "Раунд 1: независимый первичный анализ идеи. Выдели главное.",
    "Раунд 2: критика и уточнение предыдущих выводов. Найди противоречия и предложи решения.",
    "Раунд 3: совместное проектирование MVP, архитектуры и пользовательского сценария.",
    "Раунд 4: проверка реалистичности — риски, edge cases, зависимости, метрики и UX.",
    "Раунд 5: финальная позиция эксперта. Сформулируй конкретные рекомендации перед общим синтезом.",
]
...
Нужно синтезировать итоговое решение по идее пользователя на основании пяти раундов и мнений четырёх экспертов.
